...
description: Builds a Dcipher trend radar for a topic area - identifying emerging trends and placing them by momentum, impact and time to maturity - and reads how they have moved over time. Use for horizon scanning, strategic foresight, trend monitoring and "what's next / what's emerging / what should we be watching" questions about a technology, industry or theme. Use mapping-market-landscapes instead when the user wants the current structure of a market rather than what is emerging, monitoring-narratives when the interest is media coverage and framing, tracking-competitor-moves when the subject is named companies, and stress-testing-strategy when they want future scenarios rather than a trend list.
---
